...
CREATE TABLE `trabajadores` (
    ...
    `rol` ENUM('GERENTE', 'OBRERO', 'SUPERVISOR', 'PRACTICANTE') NOT NULL DEFAULT 'PRACTICANTE',
...
CREATE TABLE `asistencia` (
    ...
    UNIQUE INDEX `asistencia_id_key`(`id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_trabajador_id_fkey` FOREIGN KEY (`trabajador_id`) REFERENCES `trabajadores`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
