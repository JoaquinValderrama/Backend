...
SECRET_KEY = 'django-insecure-^rz#%bl)!t*$xe^pfewf8n#m=$j4gda$kuf)tre6r-(3a=)c&9'
...
# https://docs.djangoproject.com/en/4.0/howto/static-files/git
...
#Sirve para indicaral DJANGO que modelo de usuario tiene que utlizar en vez del original
...
SIMPLE_JWT ={
    # Modifica la duracion que tendra la token de acceso, para modificar otras propiedades de la libreria: 
